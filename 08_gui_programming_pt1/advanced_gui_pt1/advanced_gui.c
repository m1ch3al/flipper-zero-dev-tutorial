...
// Callback for manage the events generated by Submenu* 
...
AdvancedGUI* advanced_gui_app_alloc() {
    ...
    // Configuration of the dialog view
    ...
    view_dispatcher_add_view(app->view_dispatcher, ViewPerson, view_person_get_view(app->personGui));

    // Allocation of the Car view
