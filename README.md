...
|0x06|Logging (code in preparation)| Learn how to integrate the serial logging through FlipperCLI|
|0x07|Threading (code in preparation)| Simple usage of the FuriThread and how to implements them|
